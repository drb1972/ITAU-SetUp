//ITAUMCMP JOB (40600000),CLASS=A,MSGCLASS=X
//*
//* ITAUM002
//*
...
//         DD  DSN=ITAUM.COBOL(ITAUM002),DISP=SHR
//SYSLIN   DD  DSN=ITAUM.OBJECT(ITAUM002),DISP=SHR
//*
...
//SYSLIN   DD DSNAME=ITAUM.OBJECT(ITAUM002),DISP=SHR
//         DD DDNAME=SYSIN
//SYSLMOD  DD DSNAME=ITAUM.IMS.LOAD(ITAUM002),DISP=SHR
//SYSUT1   DD UNIT=VIO,SPACE=(TRK,(10,10))
//GO     EXEC PGM=*.LKED.SYSLMOD,COND=((8,LT,COMPILE),(4,LT,LKED)),
//            REGION=2048K
//STEPLIB  DD DSNAME=CEE.SCEERUN,DISP=SHR
...
//SYSLIN   DD DSNAME=ITAUM.OBJECT(ITAUM002),DISP=SHR
//         DD DDNAME=SYSIN
//SYSLMOD  DD DSNAME=ITAUM.DBRM(ITAUM002),DISP=SHR
//SYSUT1   DD UNIT=VIO,SPACE=(TRK,(10,10))
//GO     EXEC PGM=*.LKED.SYSLMOD,COND=((8,LT,COMPILE),(4,LT,LKED)),
//            REGION=2048K
//STEPLIB  DD DSNAME=CEE.SCEERUN,DISP=SHR
...
//CEEDUMP  DD SYSOUT=*
//SYSUDUMP DD SYSOUT=*
TAUM.DBRM(     IN-CAT --- ICF.MASTER.VCATLOG),DISP=SHR
//SYSUT1   DD UNIT=VIO,SPACE=(TRK,(10,10))
//GO     EXEC PGM=*.LKED.SYSLMOD,COND=((8,LT,COMPILE),(4,LT,LKED)),
//            REGION=2048K
//STEPLIB  DD DSNAME=CEE.SCEERUN,DISP=SHR
